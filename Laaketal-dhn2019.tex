...
\begin{minipage}{0.9\textwidth}
  ...
  \end{minipage}
  \caption{Excerpt from letter (from Barbarus to Semper, Nov 8., 1929) with different annotation types.  See Table~\ref{tabattrs} for metadata associated to the letter the passage comes from.}\label{fig1}
\end{figure}
